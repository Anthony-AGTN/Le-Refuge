if (document.getElementById('code') && document.getElementById('ville')) {

    /**
     * Vicopo
     * @author https://github.com/kylekatarnls
     * https://vicopo.selfbuild.
     * API HTTP et Script pour trouver les villes à partir d'un code postal et code postaux à partir d'une ville
     * Vicopo est un moyen léger et rapide rechercher une ville française et implémenter des propositions à la volée, 
     * l'autocomplétion d'un champ de ville ou de code postal et la conversion de l'un vers l'autre.
     */
